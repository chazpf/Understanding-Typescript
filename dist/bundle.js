...
define("components/project-input", ["require", "exports", "components/base-component", "util/validation", "decorators/autobind", "state/project"], function (require, exports, base_component_js_1, validation_js_1, autobind_js_1, project_js_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("components/project-list", ["require", "exports", "models/project", "components/base-component", "decorators/autobind", "state/project", "components/project-item"], function (require, exports, project_js_3, base_component_js_3, autobind_js_3, project_js_4, project_item_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class ProjectList extends base_component_js_3.Component {
        ...
        dropHandler(event) {
            ...
            project_js_4.projectState.moveProject(prjId, this.type === 'active' ? project_js_3.ProjectStatus.Active : project_js_3.ProjectStatus.Finished);
        }
        dragLeaveHandler(_) {
            const listEl = this.element.querySelector('ul');
